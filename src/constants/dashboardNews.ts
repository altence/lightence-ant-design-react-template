...
export const dashboardNews: Array<Post> = [
  {
    ...
    date: Date.now(),
    img: import.meta.env.VITE_ASSETS_BUCKET + '/med-news/Rectangle_440_1_ayb6yf.webp',
    avatarUrl: avatar1,
    author: 'Dr. Dan Reed',
    tags: [health, covid],
  },
  {
    ...
    date: Date.now(),
    img: import.meta.env.VITE_ASSETS_BUCKET + '/med-news/Rectangle_441_1_iq4y2p.webp',
    avatarUrl: avatar2,
