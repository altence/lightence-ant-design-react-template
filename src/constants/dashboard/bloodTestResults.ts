...
export const results: BloodTestResult[] = [
  ...
  { test: 'Platelets', result: 256, min: 150, max: 379, units: 'x10E3/uL' },
  ...
  { test: 'Neutrophils (abs)', result: 3.7, min: 1.4, max: 7, units: 'x10E3/uL' },
  { test: 'Lymphs (abs)', result: 2.1, min: 0.7, max: 3.1, units: 'x10E3/uL' },
  { test: 'Monocytes (abs)', result: 0.5, min: 0.1, max: 0.9, units: 'x10E3/uL' },
  { test: 'Eos (asb)', result: 0.1, min: 0, max: 0.4, units: 'x10E3/uL' },
