...
export const dashboardNews: Array<Post> = [
  {
    ...
    date: Date.now(),
    img: process.env.REACT_APP_ASSETS_BUCKET + '/med-news/Rectangle_440_2_yussyc.webp',
    avatarUrl: avatar1,
    author: 'Dr. Dan Reed',
    tags: [health, covid],
  },
  {
    ...
    date: Date.now(),
    img: process.env.REACT_APP_ASSETS_BUCKET + '/med-news/Rectangle_742_azba4d.webp',
    avatarUrl: avatar2,
